...
$form->addUpload('file5', 'Soubor k tisku (.pdf)')
     ->addCondition(Form::FILLED)
        ->addRule(Form::MAX_FILE_SIZE, 'Maximální velikost souboru je 5 MB.', 5120 * 1024 /* v bytech */);
/*--------------------------------------------------------------------*/
$label = Html::el()->setHtml('Souhlasím s <a href=".././obchodni_podminky.html" target="_blank" title="Obchodní podmínky">obchodními podmínkami</a>');
$form->addCheckbox('licence', $label)
     ->addRule(Form::FILLED, 'Je potřeba souhlasit s podmínkami', TRUE); 
