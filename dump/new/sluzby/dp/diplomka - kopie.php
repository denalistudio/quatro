...
<tr class="required">
    ...
    <td><?php echo $form['name']->control ?>
        ...
        <span class = "help">
            ...
            <span class = "text">Uvedená cena je pouze orientační a nezahrnuje cenu za samotný tisk listů práce a cenu kalkuluje s max. 4 řádky tisku na desky.</span>
        </span>
...
$(function() {
  ...
  var holidays= [[1,1],[6,4],[8,5],[1,5],[5,7],[6,7],[28,9],[28,10],[17,11],[24,12],[25,12],[26,12]];
