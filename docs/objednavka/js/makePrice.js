function makePrice() {
    ...
    var retezec = $('#termin-zhotoveni').val();   //rozebere obsah pole s terminem na casti...
    ...
    */
    ...
    var price = (priceone * $("#pevne-desky").val()) + ($("#krouzkove-vazby").val() * 70) + ($("#kapsy-cd-dvd").val() * 20) + ($("#chlopne-na-prilohy").val() * 90);
    $("ins.price-value").each(function() {
        $(this).html(price);
    })
